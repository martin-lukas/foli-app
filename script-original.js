...
// Refreshes shown bus positions. If there are no busMarkers shown, or there was a change in selection,
// or no busMarkers exist for the route at the moment, it doesn't do anything.
function refresh() {
    setSelectionFlag();
...
//  Draws busMarkers on a map from their coordinates. If the pressed button is refresh, it doesn't zoom out.
